...
/*public class cEncripta {
    ...
    public String encripta(String cadena)
    {
        ...
        {
            cad[i]+=cadena.codePointAt(i);
        }
        return cad;
        
    }
    public String muestra(Sring [])
    {
    ...
    {
        cEncripta e=new cEncripta();
        System.out.println( e.encripta("Holaaaaaaaaaaa"));
        System.out.println( e.encripta("hola"));
